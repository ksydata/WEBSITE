...
<div class="container mt-5">
	...
	<form id="infoForm" action="<c:url value='/userInfo' />" method="post" onsubmit="return combineInputs()">
    ...
    <!-- <form action="${pageContext.request.contextPath}/userInfo" method="post"> -->
        ...
        <div class="text-center mt-4">
            ...
            <!-- <a href="${pageContext.request.contextPath}/userInfo" class="btn btn-secondary">취소</a> -->
        </div>
    </form>
</div>
